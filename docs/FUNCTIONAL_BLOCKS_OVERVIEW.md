...
### 2.3. Tool Registry и Plugin Loader
...
### 2.7. Админ-панель (статический фронт)
...
## 4. Сводная таблица: из каких блоков состоит приложение
...
## 5. Что не реализовано / уточнить по документации
