...
- **Файл в Telegram:** механизм передачи файла из бота в плагин (путь к скачанному файлу, временный файл, тип .xlsx/.xls) и проверка формата — в зоне ответственности ядра/бота и плагина; в реализации учесть ограничения размера и безопасность.
