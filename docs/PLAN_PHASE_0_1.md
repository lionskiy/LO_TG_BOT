...
|----------|----------|--------|
| [ARCHITECTURE_BLUEPRINT.md](ARCHITECTURE_BLUEPRINT.md) | Целевая архитектура системы | ✅ Актуален |
| [UPGRADE_TASKS.md](UPGRADE_TASKS.md) | Декомпозиция всех задач | ✅ Актуален |
| [PLAN_PHASE_0_1.md](PLAN_PHASE_0_1.md) | Детальный план Фазы 0-1 (этот документ) | ✅ Актуален |
| [PLAN_PHASE_2.md](PLAN_PHASE_2.md) | Детальный план Фазы 2 (следующая фаза) | 📋 Планируется |
...
|------|----------|----------|--------|
| 0-1 | **[PLAN_PHASE_0_1.md](PLAN_PHASE_0_1.md)** | Стабилизация + Tool-Calling | 📍 Текущий |
| 2 | [PLAN_PHASE_2.md](PLAN_PHASE_2.md) | Plugin System | 📋 Следующий |
| 3 | [PLAN_PHASE_3.md](PLAN_PHASE_3.md) | Storage + API | 📋 Планируется |
| 4 | [PLAN_PHASE_4.md](PLAN_PHASE_4.md) | Админка Инструменты | 📋 Планируется |
| 5 | [PLAN_PHASE_5.md](PLAN_PHASE_5.md) | Админка Администраторы | 📋 Планируется |
| 6 | [PLAN_PHASE_6.md](PLAN_PHASE_6.md) | Worklog Checker | 📋 Планируется |
